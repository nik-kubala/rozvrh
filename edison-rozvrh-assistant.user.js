...
/* bundled from scripts/userscript-opening-gate.js — edit the source file, then run npm run build:userscript */
(() => {
  "use strict";
...
/* bundled from scripts/userscript-teacher-preferences.js — edit the source file, then run npm run build:userscript */
(() => {
  "use strict";
...
/* bundled from scripts/userscript-api-test.js — edit the source file, then run npm run build:userscript */
(() => {
  "use strict";
